...
def link():
    ...
    g = pd.read_csv("/Users/hanuri/Desktop/capstone_design/result/noun_list.csv", names=['noun', 'num'],
                    encoding='euc-kr')
    ...
    llist = Counter(linkcc).most_common(3)

    df = pd.DataFrame(llist, columns=['link', 'num'])
    print(df)

    df.to_csv('/Users/hanuri/Desktop/capstone_design/result/links.csv')
